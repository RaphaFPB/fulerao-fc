...
async function consultarStatusNumero(numero) {
  ...
  try {
    ...
    const souEuQueTenhoReserva =
      dados.status === "reservado" && normalizarNomeCliente(dados.nome) === normalizarNomeCliente(inputNome.value);
...
function validarFormularioPedido() {
  ...
  if (inputNumero.value === "" || isNaN(numero) || numero < 0 || numero > 99) {
    ...
    const souEuQueTenhoReserva =
      ...
      normalizarNomeCliente(estadoNumeroAtual.nome) === normalizarNomeCliente(inputNome.value);
